 ...
 */
export const deleteCollectionResponseData = z.object({
 ...
 */
export const deleteCollectionResponseDataResponse = z
  .object({
    id: z.string().optional(),
    owner: z.string().optional(),
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const deleteCollectionResponseDataRequest = z
