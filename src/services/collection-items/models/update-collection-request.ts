...
/**
 *
 * @typedef  {UpdateCollectionRequest} updateCollectionRequest
 * @property {any} - Information about the updated request. For a complete list of properties, refer to the `definitions.request` property in the [collection.json schema file](https://schema.postman.com/collection/json/v1.0.0/draft-07/collection.json).
 ...
 */
export const updateCollectionRequestResponse = z.lazy(() => {
  return z
    .object({
      data: z.any().optional(),
      meta: z.any().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const updateCollectionRequestRequest = z.lazy(() => {
  return z
    .object({
      data: z.any().nullish(),
      meta: z.any().nullish(),
