 ...
 */
export const createCollectionResponse: any = z.lazy(() => {
  return z.object({
    data: z.any().optional(),
    meta: z.any().optional(),
 ...
 */
export const createCollectionResponseResponse: any = z.lazy(() => {
  return z
    .object({
      data: z.any().optional(),
      meta: z.any().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createCollectionResponseRequest: any = z.lazy(() => {
  return z
    .object({
      data: z.any().nullish(),
      meta: z.any().nullish(),
