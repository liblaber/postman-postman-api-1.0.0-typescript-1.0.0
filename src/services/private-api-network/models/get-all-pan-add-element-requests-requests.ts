 ...
 */
export const getAllPanAddElementRequestsRequests = z.object({
 ...
 */
export const getAllPanAddElementRequestsRequestsResponse = z
  .object({
    id: z.number().optional(),
    createdAt: z.string().optional(),
    createdBy: z.number().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getAllPanAddElementRequestsRequestsRequest = z
  .object({
    id: z.number().nullish(),
    createdAt: z.string().nullish(),
    createdBy: z.number().nullish(),
    message: z.string().nullish(),
    status: requestsStatus.nullish(),
