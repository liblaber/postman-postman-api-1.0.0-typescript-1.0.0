 ...
 */
export const updatePanWorkspace = z.object({
 ...
 */
export const updatePanWorkspaceResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const updatePanWorkspaceRequest = z
  .object({ workspace: updatePanWorkspaceWorkspaceRequest.nullish() })
  .transform((data) => ({
    workspace: data['workspace'],
  }));
