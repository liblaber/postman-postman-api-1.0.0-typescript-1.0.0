...
import { z } from 'zod';
import { pullRequestUpdatedStatus } from './pull-request-updated-status';

/**
 * The shape of the model inside the application code - what the users use
 */
export const pullRequestUpdated = z.object({
 ...
 */
export const pullRequestUpdatedResponse = z
  .object({
    createdAt: z.string().optional(),
    createdBy: z.string().optional(),
    description: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const pullRequestUpdatedRequest = z
  .object({
    ...
    status: pullRequestUpdatedStatus.nullish(),
