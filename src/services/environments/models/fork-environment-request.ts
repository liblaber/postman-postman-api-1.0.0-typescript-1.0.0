 ...
 */
export const forkEnvironmentRequest = z.object({
  forkName: z.string(),
});
 ...
 */
export const forkEnvironmentRequestResponse = z
  .object({
    forkName: z.string(),
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const forkEnvironmentRequestRequest = z.object({ forkName: z.string().nullish() }).transform((data) => ({
  forkName: data['forkName'],
}));
