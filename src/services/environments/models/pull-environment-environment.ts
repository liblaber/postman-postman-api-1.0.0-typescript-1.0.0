 ...
 */
export const pullEnvironmentEnvironment = z.object({
 ...
 */
export const pullEnvironmentEnvironmentResponse = z
  .object({
    uid: z.string().optional(),
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const pullEnvironmentEnvironmentRequest = z.object({ uid: z.string().nullish() }).transform((data) => ({
  uid: data['uid'],
}));
