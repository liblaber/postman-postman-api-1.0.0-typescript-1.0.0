 ...
 */
export const getEnvironmentEnvironment = z.lazy(() => {
  return z.object({
 ...
 */
export const getEnvironmentEnvironmentResponse = z.lazy(() => {
  return z
    .object({
      id: z.string().optional(),
      name: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getEnvironmentEnvironmentRequest = z.lazy(() => {
  return z
    .object({
      id: z.string().nullish(),
