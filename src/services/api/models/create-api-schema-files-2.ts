 ...
 */
export const createApiSchemaFiles2: any = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {CreateApiSchemaFiles2} createApiSchemaFiles2 - Information about the schema file. - Information about the schema file.
 ...
 */
export type CreateApiSchemaFiles2 = z.infer<typeof createApiSchemaFiles2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const createApiSchemaFiles2Response: any = z.lazy(() => {
  return z
    .object({
      id: z.string().optional(),
      name: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createApiSchemaFiles2Request: any = z.lazy(() => {
  return z
    .object({
      id: z.string().nullish(),
