...
import { z } from 'zod';
import { addApiCollection2OperationType } from './add-api-collection-2-operation-type';

/**
 * The shape of the model inside the application code - what the users use
 */
export const addApiCollection2 = z.object({
  name: z.string().optional(),
  operationType: addApiCollection2OperationType.optional(),
 ...
 */
export const addApiCollection2Response = z
  .object({
    name: z.string().optional(),
    operationType: addApiCollection2OperationType.optional(),
    options: z.any().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const addApiCollection2Request = z
  .object({
    name: z.string().nullish(),
    operationType: addApiCollection2OperationType.nullish(),
