 ...
 */
export const getApiSchemaFileContents: any = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {GetApiSchemaFileContents} getApiSchemaFileContents - Information about the schema file. - Information about the schema file.
 ...
 */
export type GetApiSchemaFileContents = z.infer<typeof getApiSchemaFileContents>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const getApiSchemaFileContentsResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.string().optional(),
      name: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getApiSchemaFileContentsRequest: any = z.lazy(() => {
  return z
    .object({
      id: z.string().nullish(),
