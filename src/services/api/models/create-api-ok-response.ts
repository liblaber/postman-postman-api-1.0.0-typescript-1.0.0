 ...
 */
export const createApiOkResponse: any = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {CreateApiOkResponse} createApiOkResponse - The API's base data schema. - The API's base data schema.
 ...
 */
export type CreateApiOkResponse = z.infer<typeof createApiOkResponse>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const createApiOkResponseResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.string().optional(),
      name: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createApiOkResponseRequest: any = z.lazy(() => {
  return z
    .object({
      id: z.string().nullish(),
