 ...
 */
export const addApiCollection3Data = z.object({
 ...
 */
export const addApiCollection3DataResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const addApiCollection3DataRequest = z
  .object({ info: dataInfoRequest.nullish(), item: z.array(z.any()).nullish() })
  .transform((data) => ({
    info: data['info'],
    item: data['item'],
  }));
