 ...
 */
export const addApiCollectionRequest: any = z.lazy(() => {
 ...
 */
export const addApiCollectionRequestResponse: any = z.lazy(() => {
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const addApiCollectionRequestRequest: any = z.lazy(() => {
