 ...
 */
export const addApiCollectionRequest = z.union([addApiCollection1, addApiCollection2, addApiCollection3]);
 ...
 */
export const addApiCollectionRequestResponse = z.union([
  addApiCollection1Response,
  addApiCollection2Response,
  addApiCollection3Response,
]);
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const addApiCollectionRequestRequest = z.union([
  addApiCollection1Request,
  addApiCollection2Request,
  addApiCollection3Request,
]);
