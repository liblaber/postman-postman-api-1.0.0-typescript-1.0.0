...
import { z } from 'zod';
import { createApiSchemaType2 } from './create-api-schema-type-2';
import {
 ...
 */
export const createApiSchemaOkResponse = z.object({
  id: z.string().optional(),
  type_: createApiSchemaType2.optional(),
 ...
 */
export const createApiSchemaOkResponseResponse = z
  .object({
    id: z.string().optional(),
    type: createApiSchemaType2.optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createApiSchemaOkResponseRequest = z
  .object({
    id: z.string().nullish(),
    type_: createApiSchemaType2.nullish(),
