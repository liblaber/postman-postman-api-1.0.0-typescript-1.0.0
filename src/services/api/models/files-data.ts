 ...
 */
export const filesData: any = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {FilesData} filesData - Information about the schema file. - Information about the schema file.
 ...
 */
export type FilesData = z.infer<typeof filesData>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const filesDataResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.string().optional(),
      name: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const filesDataRequest: any = z.lazy(() => {
  return z
    .object({
      id: z.string().nullish(),
