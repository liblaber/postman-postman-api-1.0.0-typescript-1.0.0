 ...
 */
export const createApiVersion3Schemas = z.object({
 ...
 */
export const createApiVersion3SchemasResponse = z
  .object({
    directoryPath: z.string().optional(),
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createApiVersion3SchemasRequest = z.object({ directoryPath: z.string().nullish() }).transform((data) => ({
  directoryPath: data['directoryPath'],
}));
