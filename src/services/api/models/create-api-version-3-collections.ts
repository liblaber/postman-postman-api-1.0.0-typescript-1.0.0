 ...
 */
export const createApiVersion3Collections = z.object({
 ...
 */
export const createApiVersion3CollectionsResponse = z
  .object({
    filePath: z.string().optional(),
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const createApiVersion3CollectionsRequest = z.object({ filePath: z.string().nullish() }).transform((data) => ({
  filePath: data['filePath'],
}));
