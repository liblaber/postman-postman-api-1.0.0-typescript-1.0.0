 ...
 */
export const getCollectionPullRequests = z.lazy(() => {
  return z.object({
 ...
 */
export const getCollectionPullRequestsResponse = z.lazy(() => {
  return z
    .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getCollectionPullRequestsRequest = z.lazy(() => {
