 ...
 */
export const collectionInfo1 = z.object({
  name: z.string(),
  schema: z.string(),
});
 ...
 */
export const collectionInfo1Response = z
  .object({
    name: z.string(),
    schema: z.string(),
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const collectionInfo1Request = z
  .object({ name: z.string().nullish(), schema: z.string().nullish() })
  .transform((data) => ({
    name: data['name'],
    schema: data['schema'],
  }));
