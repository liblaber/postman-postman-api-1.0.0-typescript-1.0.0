 ...
 */
export const mergeCollectionForkRequest: any = z.lazy(() => {
  return z.object({
 ...
 */
export const mergeCollectionForkRequestResponse: any = z.lazy(() => {
  return z
    .object({
      destination: z.string(),
      source: z.string(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const mergeCollectionForkRequestRequest: any = z.lazy(() => {
  return z
