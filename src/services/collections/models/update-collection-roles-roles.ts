...
import { z } from 'zod';
import { rolesOp } from './roles-op';
import { rolesPath1 } from './roles-path-1';
import { rolesValue1, rolesValue1Request, rolesValue1Response } from './roles-value-1';

/**
 * The shape of the model inside the application code - what the users use
 */
export const updateCollectionRolesRoles = z.object({
  op: rolesOp,
  path: rolesPath1,
 ...
 */
export const updateCollectionRolesRolesResponse = z
  .object({
    op: rolesOp,
    path: rolesPath1,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const updateCollectionRolesRolesRequest = z
  .object({ op: rolesOp.nullish(), path: rolesPath1.nullish(), value: z.array(rolesValue1Request).nullish() })
  .transform((data) => ({
    op: data['op'],
    path: data['path'],
    value: data['value'],
