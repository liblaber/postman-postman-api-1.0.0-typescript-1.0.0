...
import { z } from 'zod';
import { valueRole1 } from './value-role-1';

/**
 * The shape of the model inside the application code - what the users use
 */
export const rolesValue1 = z.object({
  id: z.number(),
  role: valueRole1,
});
 ...
 */
export const rolesValue1Response = z
  .object({
    id: z.number(),
    role: valueRole1,
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const rolesValue1Request = z
  .object({ id: z.number().nullish(), role: valueRole1.nullish() })
  .transform((data) => ({
    id: data['id'],
    role: data['role'],
  }));
