 ...
 */
export const scimUserResourceMeta1: any = z.lazy(() => {
  return z.object({
 ...
 */
export const scimUserResourceMeta1Response: any = z.lazy(() => {
  return z
    .object({
      resourceType: z.string().optional(),
      created: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const scimUserResourceMeta1Request: any = z.lazy(() => {
  return z
