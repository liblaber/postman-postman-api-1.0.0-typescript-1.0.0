 ...
 */
export const updateWorkspaceGlobalVariablesOkResponse = z.object({
 ...
 */
export const updateWorkspaceGlobalVariablesOkResponseResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const updateWorkspaceGlobalVariablesOkResponseRequest = z
