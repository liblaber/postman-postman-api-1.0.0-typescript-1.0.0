 ...
 */
export const updateWorkspaceRolesRoles1Response = z
  .object({
    op: z.string(),
    path: rolesPath2,
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const updateWorkspaceRolesRoles1Request = z
  .object({ op: z.string().nullish(), path: rolesPath2.nullish(), value: z.array(rolesValue2Request).nullish() })
  .transform((data) => ({
    op: data['op'],
    path: data['path'],
    value: data['value'],
