 ...
 */
export const getAccountInvoices = z.object({
 ...
 */
export const getAccountInvoicesResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getAccountInvoicesRequest = z
  .object({ data: z.array(invoiceDataRequest).nullish() })
  .transform((data) => ({
    data: data['data'],
  }));
