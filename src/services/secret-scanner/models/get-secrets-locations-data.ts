...
import { z } from 'zod';
import { dataResourceType } from './data-resource-type';

/**
 * The shape of the model inside the application code - what the users use
 */
export const getSecretsLocationsData = z.object({
  ...
  resourceType: dataResourceType.optional(),
 ...
 */
export const getSecretsLocationsDataResponse = z
  .object({
    isResourceDeleted: z.boolean().optional(),
    leakedBy: z.number().optional(),
    location: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getSecretsLocationsDataRequest = z
  .object({
    ...
    resourceType: dataResourceType.nullish(),
