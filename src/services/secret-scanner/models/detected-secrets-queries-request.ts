...
import { workspaceVisiblities } from './workspace-visiblities';

/**
 * The shape of the model inside the application code - what the users use
 */
export const detectedSecretsQueriesRequest = z.object({
  resolved: z.boolean().optional(),
  secretTypes: z.array(z.string()).optional(),
  statuses: z.array(statuses).optional(),
  workspaceIds: z.array(z.string()).optional(),
  workspaceVisiblities: z.array(workspaceVisiblities).optional(),
});
 ...
 */
export const detectedSecretsQueriesRequestResponse = z
  .object({
    resolved: z.boolean().optional(),
    secretTypes: z.array(z.string()).optional(),
    statuses: z.array(statuses).optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const detectedSecretsQueriesRequestRequest = z
  .object({
    resolved: z.boolean().nullish(),
    secretTypes: z.array(z.string()).nullish(),
    statuses: z.array(statuses).nullish(),
    workspaceIds: z.array(z.string()).nullish(),
    workspaceVisiblities: z.array(workspaceVisiblities).nullish(),
  })
  .transform((data) => ({
    resolved: data['resolved'],
    secretTypes: data['secretTypes'],
