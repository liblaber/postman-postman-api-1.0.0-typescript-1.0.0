 ...
 */
export const getMocks = z.object({
 ...
 */
export const getMocksResponse = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const getMocksRequest = z.object({ mocks: z.array(getMocksMocksRequest).nullish() }).transform((data) => ({
  mocks: data['mocks'],
}));
