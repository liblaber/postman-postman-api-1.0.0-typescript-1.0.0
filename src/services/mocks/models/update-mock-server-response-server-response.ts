...
import { serverResponseLanguage2 } from './server-response-language-2';

/**
 * The shape of the model inside the application code - what the users use
 */
export const updateMockServerResponseServerResponse = z.object({
  name: z.string().optional(),
  statusCode: z.number().optional(),
  headers: z.array(serverResponseHeaders2).optional(),
  language: serverResponseLanguage2.optional(),
 ...
 */
export const updateMockServerResponseServerResponseResponse = z
  .object({
    name: z.string().optional(),
    statusCode: z.number().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const updateMockServerResponseServerResponseRequest = z
  .object({
    name: z.string().nullish(),
    statusCode: z.number().nullish(),
    headers: z.array(serverResponseHeaders2Request).nullish(),
    language: serverResponseLanguage2.nullish(),
