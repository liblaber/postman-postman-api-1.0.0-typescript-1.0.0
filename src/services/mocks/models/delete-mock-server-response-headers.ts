 ...
 */
export const deleteMockServerResponseHeaders = z.object({
 ...
 */
export const deleteMockServerResponseHeadersResponse = z
  .object({
    key: z.string().optional(),
    value: z.string().optional(),
  })
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const deleteMockServerResponseHeadersRequest = z
