...
import { z } from 'zod';
import { jsonStringifiedType } from './json-stringified-type';

/**
 * The shape of the model inside the application code - what the users use
 */
export const jsonStringified = z.object({
  type_: jsonStringifiedType.optional(),
 ...
 */
export const jsonStringifiedResponse = z
  .object({
    type: jsonStringifiedType.optional(),
    input: z.string().optional(),
    options: z.any().optional(),
  })
  .transform((data) => ({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const jsonStringifiedRequest = z
  .object({ type_: jsonStringifiedType.nullish(), input: z.string().nullish(), options: z.any().nullish() })
  .transform((data) => ({
    type: data['type_'],
    input: data['input'],
    options: data['options'],
