 ...
 */
export const importOpenApiDefinitionCollections = z.lazy(() => {
  return z.object({
 ...
 */
export const importOpenApiDefinitionCollectionsResponse = z.lazy(() => {
  return z
    .object({
      id: z.string().optional(),
      name: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const importOpenApiDefinitionCollectionsRequest = z.lazy(() => {
  return z
