 ...
 */
export const importOpenApiDefinitionCollections: any = z.lazy(() => {
  return z.object({
 ...
 */
export const importOpenApiDefinitionCollectionsResponse: any = z.lazy(() => {
  return z
    .object({
      id: z.string().optional(),
      name: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const importOpenApiDefinitionCollectionsRequest: any = z.lazy(() => {
  return z
