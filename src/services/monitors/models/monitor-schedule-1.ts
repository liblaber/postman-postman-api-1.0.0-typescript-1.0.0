 ...
 */
export const monitorSchedule1 = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {MonitorSchedule1} monitorSchedule1 - Information about the monitor's schedule. - Information about the monitor's schedule.
 ...
 */
export type MonitorSchedule1 = z.infer<typeof monitorSchedule1>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const monitorSchedule1Response = z.lazy(() => {
  return z
    .object({
      cron: z.string().optional(),
      timezone: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const monitorSchedule1Request = z.lazy(() => {
